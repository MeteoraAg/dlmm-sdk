    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "aAsk";
            docs: ["amplification in ask side"];
            type: "i16";
          },
          {
            name: "aBid";
            docs: ["amplification in bid side"];
            type: "i16";
          },
          {
            name: "aActiveBin";
            docs: ["amplification in active bin"];
            type: "i16";
          },
          {
            name: "centerBinId";
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "weightAsk";
            docs: ["weight in ask side"];
            type: "u16";
          },
          {
            name: "weightBid";
            docs: ["weight in bid side"];
            type: "u16";
          },
          {
            name: "weightActiveBin";
            docs: ["weight in active bin"];
            type: "u16";
          }
        ];
      };
